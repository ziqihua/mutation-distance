...
// TYPE_ID:28:double_distance(double,double,double,double):double distance = 3986 * (Math.acos(Math.sin(degree_x1) * Math.sin(degree_x2) => double distance = 3986 + (Math.acos(Math.sin(degree_x1) * Math.sin(degree_x2)
